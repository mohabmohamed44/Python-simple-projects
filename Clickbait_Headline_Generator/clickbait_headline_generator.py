...
STATES = ['California', 'Texas', 'New York', 'North Carolina', 'Michigan', 'Ohio', 'Georgia', 'Illinois', 'Florida', 'Pennsylvania']

NOUNS = ['Athlete', 'Clown', 'Shovel', 'Paleo Diet', 'Doctor', 'Parent', 'Cat', 'Dog', 'Dog', 'Chicken', 'Robot', 'Video Game', 'Avocado', 'Plastic Straw', 'Serial Killer', 'Telephone Psychic']

PLACES = ['House', 'Attic', 'Bank Deposit Box', 'School', 'Club', 'Donut Shop', 'Work Place', 'Apocalypse Bunker', 'Basement']
...
def main():
    ...
    while True:
        print('Enter a number of clickbait headline to generate: ')
        response = input('> ')
...
def generateBigCompaniesHateHerHeadline():
    ...
    return 'Big Companies Hates {}! See How This {} {} Invented cheaper {}'.format(pronoun, state, noun1, noun2)
...
def generateYouWontBelieveHeadline():
    ...
    return 'You Will Not Believe What This {} {} Found in {} {}'.format(state, noun, pronoun, place)
...
# If the program is run instead of importing, run the program
