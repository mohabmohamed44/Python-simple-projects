def read_boxes(n):
    '''
        n is number of boxes to read.
        Read boxes from the input, and return them as a list of boxes. each box is a list of action figure heights 
...
def box_ok(box):
    """
    box is a list of action figure heights in a given box.
    Return True if the heights in box are nondecreasing order
    False otherwise
    """
...
def all_endpoints_ok(endpoints):
    """
    endpoints is a list, where each value is a list of the two values:
    the heights of the leftmost and rightmost action figures in a box
